package com.example.android.worldnewsapp.Fragments.SearchFragment;
...
public class SearchFragment extends Fragment {
    ...
    public static Spinner spinnerCountry;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> dataCategoryAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, categories);
        ArrayAdapter<String> dataCountryAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, countries);
